 ...
 * <ul>
 *   <li>{@link com.ge.research.sadl.sadl.impl.ResourceListImpl#getNames <em>Names</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceListImpl extends MinimalEObjectImpl.Container implements ResourceList
{
  ...
  {
    return SadlPackage.Literals.RESOURCE_LIST;
  }
  ...
  public EList<ResourceName> getNames()
  {
    if (names == null)
    {
      names = new EObjectContainmentEList<ResourceName>(ResourceName.class, this, SadlPackage.RESOURCE_LIST__NAMES);
    }
    return names;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SadlPackage.RESOURCE_LIST__NAMES:

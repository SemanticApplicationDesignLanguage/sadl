...
import com.naturalsemantics.sadl.sitl.parser.antlr.internal.InternalSITLParser

class SitlTokenToAttributeIdMapper extends DefaultAntlrTokenToAttributeIdMapper {
	...
	override protected String calculateId(String tokenName, int tokenType) {
		...
		var String ruleNumber = {
			val _rdIndx_tmpNode = InternalSITLParser.RULE_NUMBER //UNSIGNED_NUMBER
			InternalSITLParser.tokenNames.get(_rdIndx_tmpNode)
		}

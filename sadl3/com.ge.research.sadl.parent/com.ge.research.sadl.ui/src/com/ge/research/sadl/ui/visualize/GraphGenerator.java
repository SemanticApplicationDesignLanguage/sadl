 ...
 * 
 * Notes
 *   1. Graph file naming convention
 *   	The file name of a graph is generated by the actual instance of IGraphVisualizer from a base filename.
 *   	This base filename is derived from the file being graphed, e.g., a .sadl or .owl file. Because it is possible
 *    	that files being graphed may be the same, except for the extension, the extension is retained as part of the
 *    	base filename.
 * */
public class GraphGenerator {
	...
	public GraphGenerator(IConfigurationManagerForIDE configMgr, IProject project, String publicUri, ConceptName startNode) throws ConfigurationException, IOException {

...
public class SadlJenaModelGetterPutter extends SadlJenaModelGetter {
     ...
     */
    public SadlJenaModelGetterPutter(OntModelSpec modelSpec, String modelFolder) throws ConfigurationException {
    	super(modelSpec, modelFolder);
     ...
     * @param format
     */
    public SadlJenaModelGetterPutter(OntModelSpec modelSpec, String _tdbFolder, String format) {
    	super(modelSpec, _tdbFolder, format);

...
//				// UnittedQuantity on LHS
//				Object[] extensions = getUnittedQuantityExpansions(gpe, args);
//				Node[] replacements = (Node[]) extensions[0];
//				TripleElement[] newTriples = (TripleElement[]) extensions[1];
//				for (TripleElement tr : newTriples) {
//					addAdditionalWhereTriple(tr);
//				}
//				if (replacements != null && replacements.length == 2) {
//					String filter = nodeToString(replacements[0], TranslationTarget.QUERY_FILTER) + " " + gpe.getFuncName() + " " + nodeToString(replacements[1], TranslationTarget.QUERY_FILTER);
//					return filter;
//				}
//				else {
//					throw new TranslationException("UnittedQuantity extension failed to find new lefthand side and value");
//				}
//			}
//			else if (args.get(1) instanceof Literal && ((Literal)args.get(1)).getUnits() != null) {
//				// UnittedQuantity on RHS
//				Object[] extensions = getUnittedQuantityExpansions(gpe, args);
//				Node[] replacements = (Node[]) extensions[0];
//				TripleElement[] newTriples = (TripleElement[]) extensions[1];
//				for (TripleElement tr : newTriples) {
...
//				}
//				else if (args.get(1) instanceof Literal && ((Literal)args.get(1)).getUnits() != null) {
//					Object[] extensions = getUnittedQuantityExpansions((BuiltinElement) gpe, args);
//					Node[] replacements = (Node[]) extensions[0];
//					TripleElement[] newTriples = (TripleElement[]) extensions[1];
//					for (TripleElement tr : newTriples) {
//						addAdditionalWhereTriple(tr);
//					}
//					args.set(0, replacements[0]);
//					args.set(1, replacements[1]);
//				}
//			}

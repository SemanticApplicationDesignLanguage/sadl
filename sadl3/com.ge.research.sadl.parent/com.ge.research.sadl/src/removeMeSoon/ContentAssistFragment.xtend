 ...
 */
class ContentAssistFragment42 extends ContentAssistFragment2 {
	...
	override protected TypeReference getProposalProviderClass(Grammar g) {
		return new TypeReference(
			g.eclipsePluginBasePackage + ".contentassist." + g.simpleName + "ProposalProvider"
		)
	}

	override protected TypeReference getGenProposalProviderClass(Grammar g) {
		return new TypeReference(
			g.eclipsePluginBasePackage + ".contentassist.Abstract" + g.simpleName + "ProposalProvider"
		)
	}

	override protected TypeReference getGenProposalProviderSuperClass(Grammar g) {
	 ...
	 */
	override protected TypeReference getDefaultGenProposalProviderSuperClass() {
	...
	override generateJavaProposalProviderStub() {
	...
	override generateGenJavaProposalProvider() {
	...
	override getFQFeatureNamesToExclude(Grammar g) {

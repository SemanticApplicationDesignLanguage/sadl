...
interface ISadlOntologyHelper {
	...
	static abstract class GrammarContextIds {
		...
		public static val SADLPROPERTYRESTRICTION_OTHERPROPERTY = 'SADLPROPERTYRESTRICTION_OTHERPROPERTY';
		...
		public static val SADLSTATEMENT_PROPCONDITIONS = 'SADLSTATEMENT_PROPCONDITIONS';
		
		public static val SADLHASVALUECONDITION_RESTRICTION = 'SADLHASVALUECONDITION_RESTRICTION';
		
		public static val SADLNESTEDINSTANCE_TYPE = 'SADLNESTEDINSTANCE_TYPE';
...
//			SADLPROPERTYRESTRICTION_OTHERPROPERTY,
			PROPOFSUBJECT_PROP,
			PROPOFSUBJECT_RIGHT,
			...
			SADLSTATEMENT_TYPE,
			SADLSTATEMENT_PROPCONDITIONS,
			SADLHASVALUECONDITION_RESTRICTION,
			SADLNESTEDINSTANCE_TYPE
		}

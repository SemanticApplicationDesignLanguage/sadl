...
public class AdHocQueryAction extends SadlAction {
	...
	public AdHocQueryAction(File prjFolder, File trgtFile, Map<String, String> prefMap, String query) {
				...
				if (resourceSet != null) {
			    	...
			    	if (res != null) {
						if (processorProvider != null) {
							...
							processor.processAdhocQuery(res, new ValidationAcceptor(null),  new ProcessorContext(CancelIndicator.NullImpl,  preferenceProvider.getPreferenceValues(res)), query);
						}
			    	}
				}
			}

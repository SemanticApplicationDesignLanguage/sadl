...
public abstract class ErrorGeneratorBase {
	private final static String warningComment = String.join("\n", 
	...
	private final static String varDeclaration = "public static final ErrorMessage ";
	private final static String newErrorMsg = "new ErrorMessage(";
	 ...
	 */
	abstract String getProjectPrefix();
	 ...
	 */
	abstract String getDocumentationFilePath();
		...
		for(Enumeration<String> keys = msgBundle.getKeys(); keys.hasMoreElements();) {
			...
			if(!key.contains(".")){
				...
				sourceContent += String.join(newline, 
								...
								"* " + msg,
								"**/",
								indent + varDeclaration + key.toUpperCase() + " = " + newErrorMsg + "\"" + key 
										+ "\"" + endErrorMsg,
								"");

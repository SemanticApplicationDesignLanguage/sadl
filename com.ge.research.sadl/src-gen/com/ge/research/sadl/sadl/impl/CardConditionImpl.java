...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Card Condition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.ge.research.sadl.sadl.impl.CardConditionImpl#getCard <em>Card</em>}</li>
 *   <li>{@link com.ge.research.sadl.sadl.impl.CardConditionImpl#getClassQualifier <em>Class Qualifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CardConditionImpl extends ConditionImpl implements CardCondition
{
  /**
  ...
  {
    return SadlPackage.Literals.CARD_CONDITION;
  }
  ...
  public void setCard(String newCard)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SadlPackage.CARD_CONDITION__CARD, oldCard, card));
  }
  ...
  public NotificationChain basicSetClassQualifier(ResourceIdentifier newClassQualifier, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SadlPackage.CARD_CONDITION__CLASS_QUALIFIER, oldClassQualifier, newClassQualifier);
  ...
  public void setClassQualifier(ResourceIdentifier newClassQualifier)
  {
    if (newClassQualifier != classQualifier)
    {
      ...
      if (classQualifier != null)
        msgs = ((InternalEObject)classQualifier).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SadlPackage.CARD_CONDITION__CLASS_QUALIFIER, null, msgs);
      if (newClassQualifier != null)
        msgs = ((InternalEObject)newClassQualifier).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SadlPackage.CARD_CONDITION__CLASS_QUALIFIER, null, msgs);
      msgs = basicSetClassQualifier(newClassQualifier, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SadlPackage.CARD_CONDITION__CLASS_QUALIFIER, newClassQualifier, newClassQualifier));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SadlPackage.CARD_CONDITION__CLASS_QUALIFIER:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SadlPackage.CARD_CONDITION__CARD:
        return getCard();
      case SadlPackage.CARD_CONDITION__CLASS_QUALIFIER:

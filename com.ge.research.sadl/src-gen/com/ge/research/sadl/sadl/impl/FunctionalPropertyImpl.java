 ...
 * <ul>
 *   <li>{@link com.ge.research.sadl.sadl.impl.FunctionalPropertyImpl#getPropertyName <em>Property Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionalPropertyImpl extends StatementImpl implements FunctionalProperty
{
  ...
  public NotificationChain basicSetPropertyName(ResourceByName newPropertyName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SadlPackage.FUNCTIONAL_PROPERTY__PROPERTY_NAME, oldPropertyName, newPropertyName);
  ...
  public void setPropertyName(ResourceByName newPropertyName)
  {
    if (newPropertyName != propertyName)
    {
      ...
      if (propertyName != null)
        msgs = ((InternalEObject)propertyName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SadlPackage.FUNCTIONAL_PROPERTY__PROPERTY_NAME, null, msgs);
      if (newPropertyName != null)
        msgs = ((InternalEObject)newPropertyName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SadlPackage.FUNCTIONAL_PROPERTY__PROPERTY_NAME, null, msgs);
      msgs = basicSetPropertyName(newPropertyName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SadlPackage.FUNCTIONAL_PROPERTY__PROPERTY_NAME, newPropertyName, newPropertyName));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SadlPackage.FUNCTIONAL_PROPERTY__PROPERTY_NAME:

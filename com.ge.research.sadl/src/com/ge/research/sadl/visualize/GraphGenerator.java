...
public class GraphGenerator {
	...
	public GraphGenerator(ModelManager mgr, OntModel m, ConceptName startNode) {
		mmgr = mgr;
		model = m;
		anchor = startNode;
	}
	...
	public ResultSet generateClassHierarchy(int size) throws ConfigurationException {
		OntClass cls = mmgr.getOntResourceInExistingModel(anchor).as(OntClass.class);
...
//		}
	...
	public ResultSet generateIndividualNeighborhood(int size) throws ConfigurationException {
		Individual inst = mmgr.getOntResourceInExistingModel(anchor).as(Individual.class);
		List<GraphSegment> data = new ArrayList<GraphSegment>();
